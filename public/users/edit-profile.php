...
<?php include ('/home/u174976054/domains/nyclibraryandpolicy.website/public_html/nyclibrary/public/users/includes/navbar.php');?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <?php include ('/home/u174976054/domains/nyclibraryandpolicy.website/public_html/nyclibrary/public/users/includes/topbar.php');?>
                ...
                <!------------------------------------------------------edit-email.php----------------------------------------------------------->
                <div class="mb-3">
                    <button type="submit" class="add_admin btn btn-outline-secondary" name="user-edit-email">Change Registered Email</button>
                </div>
                <!------------------------------------------------------edit-password.php----------------------------------------------------------->
                <div class="mb-3">
                    <button type="submit" class="add_admin btn btn-outline-secondary" name="user-edit-password">Change Password</button>
                </div>
                <button type="submit" class="add_admin btn btn-primary" name="edit-user-profile">Update</button>
            </form>
