    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer border-top-0 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" name="add_document_admin">Add Document</button>
        </div>
        </form>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <input type="hidden" name="no_docu" id="no_docu">
        ...
        <div class="modal-footer border-top-0 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" name="edit_doc_admin">Update</button>
        </div>
        </form>
    </div>
  </div>
                                            ...
                                            <table id="data" class="table table-hover" id="dataTable" width="100%">
                                                ...
                                                while($row = mysqli_fetch_array($result)):
                                                    ...
                                                    <tr>
                                                        ...
                                                        <br>
                                                        <br>
                                                        <a href="../../../nyclibrary/function/archive-document-admin.php?no_docu=<?= $row["no_docu"]; ?>" type="button" class="btn btn-outline-warning archive_btn"> Archive </a>
                                                        </td>
                                                    </tr>
                                                    <?php endwhile; ?>
