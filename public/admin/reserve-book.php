                                                ...
                                                while($row = mysqli_fetch_array($result)):
                                                    ...
                                                    <?php
                                                        if ($row["no_copies"] > 0):
                                                            ?>
                                                    <td>
                                                        <a href="../../../nyclibrary/function/book-reservation-admin.php?no_book=<?= $row["no_book"];?>&isbn=<?= $row["isbn"];?>&emp_id=<?= $currentUser;?>" type="button" class="btn btn-success reserve_btn">Reserve</a>
                                                    </td>
                                                    <?php endif; ?> 
                                                    <?php
                                                        if ($row["no_copies"] == 0):
