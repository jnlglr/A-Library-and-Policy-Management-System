    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer border-top-0 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" name="add_bill_btn_admin">Add Bill</button>
        </div>
        </form>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer border-top-0 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" name="edit_bill_admin">Update</button>
        </div>
        </form>
    </div>
  </div>
                                            ...
                                            <table id="data" class="table table-hover" id="dataTable" width="100%">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <br>
                                                        <br>
                                                        <a href="../../../nyclibrary/function/archive-bill-admin.php?senatebill_id=<?= $row["senatebill_id"]; ?>" type="button" class="btn btn-outline-warning archive_btn"> Archive </a>
                                                        </td>
                                                    </tr>
                                                    <?php endwhile; ?>
                                                <tbody>
