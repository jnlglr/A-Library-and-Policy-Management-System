    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer border-top-0 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" name="add_thesis_admin">Add Thesis</button>
        </div>
        </form>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <input type="hidden" name="thesis_no" id="thesis_no">
        ...
        <div class="modal-footer border-top-0 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" name="edit_thesis_admin">Update</button>
        </div>
        </form>
    </div>
  </div>
            ...
            <?php include ('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900">Thesis Catalog</h1>
                    ...
                    ?>
                        ...
                        <div class="container-fluid">
                            ...
                            <p class="mb-4 text-gray-60">This section allows you to add, update, and archive thesis.</p>
                                <!-- DataTales Example -->
                                            ...
                                            <table id="data" class="table table-hover" id="dataTable" width="100%">
                                                ...
                                                while($row = mysqli_fetch_array($result)):
                                                    ...
                                                    <td>
                                                        ...
                                                        <br>
                                                        <br>
                                                        <a href="../../../nyclibrary/function/archive-thesis-admin.php?thesis_no=<?= $row["thesis_no"]; ?>" type="button" class="btn btn-outline-warning archive_btn"> Archive </a>
                                                    </td>
                                                    </tr>
                                                    <?php endwhile; ?>
                                                <tbody>
