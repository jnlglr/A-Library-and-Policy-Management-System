    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            // connect to database
                ...
                $query = "SELECT * FROM `bookarchive` ORDER BY title";
            ...
            <div class="container-fluid">
                <!-- Page Heading -->
                <p class="mb-4 text-gray-60">This page shows the archived books.</p>
                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="h5 m-0 font-weight-bold text-primary">Books Archive</h6>
                    </div>
