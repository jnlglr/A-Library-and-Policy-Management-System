  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header border-bottom-0">
        <h5 class="modal-title" id="deleteModalLabel">Edit Policy</h5>
                                            ...
                                            <table id="data" class="table table-hover" id="dataTable" width="100%">
                                                ...
                                                ?>
                                                    ...
                                                    <?php endif; ?>
                                                        ...
                                                        <?php
                                                        echo "<a onClick=\" javascript:return confirm('Are you sure you want to delete this?'); \" href='../../../nyclibrary/function/delete-user.php?emp_id={$row["emp_id"]}'type='button' class='btn btn-outline-danger del_btn'> Delete </a>";
                                                        ?>
