            ...
            <div class="row">
                <div class="col-md-12 pop shadow" >
                    <div class="card-header">
                        <h4>This section allows you to edit your profile</h4>
                    </div>
                    <div class="card-body">
                        <form action="../../../nyclibrary/function/function.php"  method="post">
                            ...
                            <!------------------------------------------------------edit-email.php----------------------------------------------------------->
                            <div class="mb-3">
                                <button type="submit" class="add_admin btn btn-outline-secondary" name="admin-edit-email">Change Registered Email</button>
                            </div>
            
                            <!------------------------------------------------------edit-password.php----------------------------------------------------------->
                            <div class="mb-3">
                                <button type="submit" class="add_admin btn btn-outline-secondary" name="admin-edit-password">Change Password</button>
                            </div>
                            <button type="submit" class="add_admin btn btn-primary" name="edit-admin-profile">Update</button>
                        </form>
                    </div>
                </div>
            </div>
