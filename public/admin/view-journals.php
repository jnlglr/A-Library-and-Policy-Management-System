    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer border-top-0 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" name="add_journal_admin">Add Journal</button>
        </div>
        </form>
    </div>
  </div>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="../../../nyclibrary/function/function.php"  method="post">
      <input type="hidden" name="no_journal" id="no_journal">
        <div class="modal-body">
        ...
        <div class="modal-footer border-top-0 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" name="edit_journal_admin">Update</button>
        </div>
        </form>
    </div>
  </div>
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900">Journals Catalog</h1>
                    ...
                    ?>
                        ...
                        <div class="container-fluid">
                            ...
                            <p class="mb-4 text-gray-60">This page allows you to add, update, and archive journals.</p>
                                <!-- DataTales Example -->
                                                ...
                                                while($row = mysqli_fetch_array($result)):
                                                   ...
                                                   ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="../../../nyclibrary/function/archive-journal-admin.php?no_journal=<?= $row["no_journal"]; ?>" type="button" class="btn btn-outline-warning archive_btn"> Archive </a>
                                                    </td>
                                                    </tr>
                                                    <?php endwhile; ?>
                                                <tbody>
