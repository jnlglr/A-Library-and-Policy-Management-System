    ...
    <div class="modal-content">
      ...
      <input type="hidden" name="emp_id" value="<?php 
        ...
        <div class="modal-footer border-top-0 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" name="add_policy_admin">Add Policy</button>
        </div>
        </form>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <input type="hidden" name="policy_id" id="policy_id">
        ...
        <div class="modal-footer border-top-0 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" name="edit_policy_admin">Update</button>
        </div>
        </form>
    </div>
  </div>
                                            ...
                                            <table id="data" class="table table-hover" id="dataTable" width="100%">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <br>
                                                        <br>
                                                        <a href="../../../nyclibrary/function/archive-policy-admin.php?policy_id=<?= $row["policy_id"]; ?>" type="button" class="btn btn-outline-warning archive_btn"> Archive </a>
                                                        </td>
                                                    </tr>
                                                    <?php endwhile; ?>
                                                <tbody>
