                                        ...
                                        <thead class="thead-light">
                                         ...
                                         <?php
                                                while($row = mysqli_fetch_array($result)):
                                                    ...
                                                    <td><?= $row["due_date"];?></td>
                                                    <td>
                                                        <a href="../../../nyclibrary/function/book-returned-admin.php?reservation_id=<?= $row["reservation_id"];?>&book_id_reserv=<?= $row['book_id_reserv'];?>" type="button" class="btn btn-success reserve_btn"> Returned </a>
                                                    </td>
                                                    </tr>
                                                    <?php endwhile; ?> 
                                                <tbody>
