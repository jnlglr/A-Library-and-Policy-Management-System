    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer border-top-0 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" name="add_magazine_admin">Add Magazine</button>
        </div>
        </form>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer border-top-0 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" name="edit_magazine_admin">Edit Magazine</button>
        </div>
        </form>
    </div>
  </div>
                                            ...
                                            <table id="data" class="table table-hover" id="dataTable" width="100%">
                                                ...
                                                while($row = mysqli_fetch_array($result)):
                                                    ...
                                                    <tr>
                                                        ...
                                                        <a href="../../../nyclibrary/function/archive-magazine-admin.php?no_magazine=<?= $row["no_magazine"]; ?>" type="button" class="btn btn-outline-warning archive_btn"> Archive </a>
                                                    </td>
                                                    </tr>
                                                    <?php endwhile; ?>
                                                <tbody>
