    ...
    <div class="modal-content">
      ...
      <input type="hidden" name="emp_id" value="<?php 
        ...
        <div class="modal-footer border-top-0 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" name="add_cd">Add CD</button>
        </div>
        </form>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <input type="hidden" name="no_cd" id="no_cd">
        ...
        <div class="modal-footer border-top-0 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" name="edit_cd">Update</button>
        </div>
        </form>
    </div>
  </div>
                                            ...
                                            <table id="data" class="table table-hover" id="dataTable" width="100%">
                                                ...
                                                while($row = mysqli_fetch_array($result)):
                                                    ...
                                                    <tr>
                                                        ...
                                                        <a href="../../../nyclibrary/function/archive-cd.php?no_cd=<?= $row["no_cd"];?>&emp_id=<?= $row["emp_id"];?>&title=<?= $row["title"];?>" type="button" class="btn btn-outline-warning archive_btn"> Archive </a>
                                                        </td>
                                                    </tr>
                                                    <?php endwhile; ?>
                                                <tbody>
