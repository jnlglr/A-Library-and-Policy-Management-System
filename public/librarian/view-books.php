  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <input type="hidden" name="no_book" id="no_book">
        ...
        <div class="modal-footer border-top-0 d-flex justify-content-center">
            <button type="submit" class="btn btn-primary" name="edit_book">Update</button>
        </div>
        </form>
    </div>
  </div>
                            ...
                            while($row = mysqli_fetch_array($result)):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br>
                                        <br>
                                        <a href="../../../nyclibrary/function/archive-book.php?no_book=<?= $row["no_book"]; ?>" type="button" class="btn btn-outline-warning archive_btn"> Archive </a>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                            <tbody>
